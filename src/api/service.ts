...
export const getHousekeepingStats = () =>
  http<HousekeepingStats>('/housekeeping/stats');
...
export const deleteHousekeepingTask = (_id: string) =>
  http<void>(`/housekeeping/${_id}`, { method: 'DELETE' });
...
export const getMaintenanceStats = () =>
  http<MaintenanceStats>('/maintenance/stats');
